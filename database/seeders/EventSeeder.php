    ...
    public function run()
    {
        $events = [
            ...
            [
                ...
                'content' => '<p>Seminar ini menghadirkan para ahli pendidikan nasional untuk membahas strategi pembentukan karakter generasi muda. Topik utama meliputi: penguatan nilai-nilai Pancasila di era digital, manajemen emosi, serta kolaborasi sekolah dengan orang tua dalam pembentukan karakter siswa.</p><p>Peserta akan menerima sertifikat nasional. Kuota terbatas, daftar segera!</p>',
            ...
            [
                ...
                'content' => '<p>Festival tahunan yang menampilkan bakat seni siswa dalam berbagai kategori: tari tradisional, musik, teater, lukis, fotografi, dan fashion show. Setiap kelas berkompetisi dalam masing-masing kategori untuk memperebutkan tropi juara umum.</p><p>Acara ini juga mengundang seniman lokal untuk memberikan workshop singkat kepada siswa. Ayo rayakan keberagaman budaya Indonesia bersama kami!</p>',
