...
export default function Guru({
    ...
    const hasActiveFilters =
        filters.jenis || filters.bidang_studi || filters.search;
                        ...
                        <div className="absolute inset-0 flex items-center justify-center">
                            ...
                            >
                                ...
                                <p className="text-lg md:text-xl text-white/90 max-w-2xl mx-auto font-light">
                                    Para pendidik profesional yang membimbing
                        ...
                        <div className="container mx-auto px-4 max-w-7xl">
                            ...
                            >
                                ...
                                >
                                    ...
                                    />
                                    <p className="text-3xl font-extrabold text-gray-900 tabular-nums">
                                        {tendikCount.toLocaleString("id-ID")}
                                    </p>
                                    <p className="text-gray-500 text-xs mt-0.5">
                                        Tenaga Admin
                                    </p>
                                ...
                                <div className="grid md:grid-cols-3 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            style={{
                                                ["--tw-ring-color" as any]: `${secondaryColor}40`,
                                            }}
                                        />
                                    </div>
