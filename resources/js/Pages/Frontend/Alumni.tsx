        ...
        >
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              ...
              >
                ...
                <p className="text-lg md:text-xl text-white/90 max-w-2xl mx-auto font-light">
                  Terhubung dengan{' '}
                  <span className="font-bold text-yellow-300">{totalAlumniCount.toLocaleString('id-ID')}+</span>{' '}
          ...
          <section className="py-12 -mt-8">
            <div className="container mx-auto px-4 max-w-7xl">
              ...
              >
                ...
                <div className="bg-white rounded-2xl shadow-lg p-6 text-center border border-gray-100">
                  <p className="text-3xl md:text-4xl font-extrabold text-gray-900 tabular-nums">
                    {totalAlumniCount.toLocaleString('id-ID')}
                  </p>
                  <p className="text-gray-500 text-sm mt-1">Total Alumni</p>
                </div>

                {/* Berbagai Profesi */}
                <div className="rounded-2xl shadow-lg p-6 text-center text-white" style={{ backgroundColor: secondaryColor }}>
                  <Briefcase className="w-9 h-9 mx-auto mb-2" strokeWidth={1.5} />
                  <p className="text-sm font-medium opacity-90">Berbagai Profesi</p>
                </div>

                {/* Seluruh Indonesia */}
                <div className="rounded-2xl shadow-lg p-6 text-center border border-gray-100"
                  style={{ backgroundColor: `${primaryColor}20` }}>
                  <MapPin className="w-9 h-9 mx-auto mb-2" style={{ color: secondaryColor }} strokeWidth={1.5} />
                  <p className="text-sm font-medium text-gray-700">Seluruh Indonesia</p>
                </div>

                {/* Forum */}
                <div className="rounded-2xl shadow-lg p-6 text-center border border-gray-100"
                  style={{ backgroundColor: `${secondaryColor}10` }}>
                  <MessageCircle className="w-9 h-9 mx-auto mb-2" style={{ color: secondaryColor }} strokeWidth={1.5} />
                  <p className="text-sm font-medium text-gray-700">Forum & Networking</p>
                </div>
              </motion.div>
              ...
              >
                {[
                  { href: '/alumni', label: 'Direktori Alumni', icon: Users, active: true },
                  { href: '/alumni/tracer-study', label: 'Tracer Study', icon: BarChart3, active: false },
                  { href: '/alumni/forum', label: 'Forum Alumni', icon: MessageCircle, active: false },
                  { href: '/alumni/donasi', label: 'Donasi', icon: Heart, active: false },
                ].map((tab) => (
                  <Link
                    key={tab.href}
                    href={tab.href}
              ...
              {alumni.data.length > 0 ? (
                    ...
                    {alumni.data.map((alumnus) => (
                      ...
                      >
                        ...
                        <div className="px-5 -mt-12 relative">
                          ...
                          <p className="text-center text-sm font-semibold mb-3" style={{ color: secondaryColor }}>
                          ...
                          <div className="space-y-2 text-sm">
                            ...
                            <div className="flex items-start gap-2 text-gray-600">
                              <MapPin className="w-4 h-4 flex-shrink-0 mt-0.5" style={{ color: secondaryColor }} strokeWidth={2} />
                          ...
                          <div className="flex justify-center gap-2 mt-4 pt-4 border-t border-gray-100">
                            ...
                            <a href={`mailto:${alumnus.user.email}`}
                              className="w-8 h-8 rounded-full flex items-center justify-center transition hover:scale-110"
                ...
                >
                  ...
                  <h3 className="text-2xl font-bold text-gray-900 mb-2">Belum Ada Alumni</h3>
                  <p className="text-gray-500 max-w-md mx-auto">
                    Data alumni akan muncul setelah pendaftaran dan verifikasi.
                  </p>
                </motion.div>
              )}
              ...
              <motion.div
                ...
                style={{ background: `linear-gradient(135deg, ${secondaryColor}, ${secondaryColor}DD, ${primaryColor}50)` }}
              >
                <div className="absolute -top-20 -right-20 w-80 h-80 rounded-full opacity-10"
                  style={{ background: `radial-gradient(circle, ${primaryColor}, transparent 70%)` }} />
