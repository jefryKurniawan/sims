...
interface FrontendIndexProps {
    ...
    pengajar: Array<{
        id: number;
        name: string;
        userDetail: { mengajar: string } | null;
    }>;
}

export default function Index({ berita, event, pengajar }: FrontendIndexProps) {
    ...
    React.useEffect(() => {
        ...
        if (typeof window !== "undefined") {
            gsap.to(
                [heroRef1.current, heroRef2.current, heroRef3.current].filter(
                    Boolean,
                ),
                {
    ...
    return (
        <>
            ...
            {/* ── HERO ── */}
            <section
                className="relative h-screen min-h-[600px] flex items-center overflow-hidden pt-20 hero-section"
            ...
            >
                ...
                <div className="relative z-10 px-6 md:px-12 max-w-7xl mx-auto w-full">
                    <div className="max-w-2xl">
                        <span
                            className="hero-badge inline-block px-4 py-2 rounded-full uppercase text-xs font-bold tracking-widest mb-6 shadow-sm text-gray-900"
                        ...
                        <p className="text-lg md:text-xl text-white/80 mb-10 max-w-xl">
                            Ruang belajar modern untuk generasi wason depan
                            dengan pondasi karakter yang kuat.
                        </p>
                        <div className="flex flex-col sm:flex-row gap-4">
                            <Link
                                href={route("program.index")}
                                className="btn-primary inline-flex items-center justify-center gap-2 text-white font-bold px-8 py-4 rounded-lg hover:shadow-xl transition-all"
                            ...
                            <Link
                                href="/spmb/daftar"
                                className="btn-outline inline-flex items-center justify-center gap-2 bg-white/10 border border-white/40 text-white font-bold px-8 py-4 rounded-lg hover:bg-white/20 transition-all"
                            >
                                Daftar SPMB
                            </Link>
                        </div>
            ...
            {/* ── DATA STATS ── */}
            <section
                className="py-16 animate-on-scroll"
                style={{ backgroundColor: secondaryColor }}
            >
                ...
                <div className="max-w-7xl mx-auto px-6 md:px-12">
                    <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
                        <div className="max-w-2xl">
                            ...
                            <p className="text-gray-600 text-lg">
                                Melatih nilai unggulan dan karakter siswa-siswi
                                dalam bidang akademik maupun non-akademik.
                            </p>
                        </div>
                        <Link
                            href={route("program.index")}
                            className="text-destructive font-bold text-sm flex items-center gap-1 hover:gap-2 transition-all"
                        >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {[
                            {
                                icon: Monitor,
                                title: "Sistem Pembelajaran Mandiri & Terukur",
                                desc: "Mempersiapkan generasi adaptif melalui kurikulum nasional yang diperkaya nilai humanis.",
                            },
                            {
                                icon: Globe,
                                title: "Kurikulum Merdeka Berbasis Karakter",
                                desc: "Fokus pada pengembangan bakat alami, penalaran kritis, dan iman yang teguh.",
                            },
                            {
                                icon: FlaskConical,
                                title: "Ruang Tumbuh Bakat & Potensi Siswa",
                                desc: "Program pembelajaran untuk kesiapan studi lanjut dan masa depan.",
                            },
                        ].map((f, i) => (
                            <div
                                key={i}
                                className={`bg-white p-10 border border-yellow-200 rounded-xl transition-all duration-300 hover:-translate-y-1 hover:shadow-lg border-l-4 border-l-yellow-400 pillar-card`}
                            >
                                <div
                                    className="w-14 h-14 bg-yellow-50 flex items-center justify-center rounded-lg mb-8"
                ...
                <div className="max-w-7xl mx-auto px-6 md:px-12">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-gray-600 text-lg max-w-2xl mx-auto">
                            Ikuti perkembangan terbaru dari komunitas SMAS St.
                            Bonaventura
                        </p>
                    </div>
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                        {berita[0] && (
                            <div className="lg:col-span-8 lg:row-span-2 group relative rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all h-[400px] lg:h-[600px]">
                                <div
                                    className="absolute inset-0 bg-cover bg-center news-image"
                                    style={{
                                        backgroundImage: `url('http://smabona.sch.id/wp-content/uploads/2023/04/smabona1.png')`,
                                    }}
                                />
                                <div className="absolute inset-0 bg-gradient-to-t from-red-900/90 via-gray-900/40 to-transparent" />
                                <div className="absolute bottom-0 left-0 p-8 w-full">
                                    <div className="flex gap-3 mb-4">
                                        <span className="bg-yellow-400 text-gray-900 px-3 py-1 rounded text-xs font-bold uppercase">
                                            Berita
                                        </span>
                                    ...
                                    <Link
                                        href={`/berita/${berita[0].slug}`}
                                        className="inline-flex items-center gap-2 text-yellow-400 font-bold hover:gap-3 transition-all"
                                    >
                                        Baca Selengkapnya{" "}
                                        <ArrowRight className="w-4 h-4" />
                                    </Link>
                        ...
                        <div className="lg:col-span-4 bg-white border border-yellow-200 rounded-2xl p-8 flex flex-col shadow-sm">
                            <div className="mb-6 rounded-lg overflow-hidden h-48 bg-gray-100">
                                <img
                                    src="https://smabona.sch.id/wp-content/uploads/2025/11/WhatsApp-Image-2025-10-17-at-08.19.29_b0ba88d9.jpg"
                                    alt="SPMB"
                            ...
                            <div className="flex justify-between items-center mb-4">
                                <span className="text-destructive font-bold text-xs uppercase">
                                    Admisi
                                </span>
                            ...
                            <h4 className="text-lg font-bold text-gray-900 mb-4">
                                Penerimaan Murid Baru {new Date().getFullYear()}
                                /{new Date().getFullYear() + 1}
                            </h4>
                            <p className="text-gray-600 text-sm mb-6 flex-grow">
                                Saatnya tumbuh cerdas dan berkarakter di SMAS
                                St. Bonaventura Madiun
                            </p>
                            <Link
                                href="/spmb/daftar"
                                className="text-destructive font-bold text-sm underline decoration-yellow-400 decoration-4 underline-offset-4"
                            >
                                Daftar Sekarang
                            </Link>
                        </div>
                        <div
                            className="lg:col-span-4 text-white rounded-2xl p-8 flex flex-col shadow-sm"
                            style={{ backgroundColor: secondaryColor }}
                        >
                            ...
                            <p className="text-white/80 text-sm mb-6 flex-grow">
                                Kolaborasi sekolah dengan orang tua dalam
                                mendampingi tumbuh kembang emosional siswa
                            </p>
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-between mb-20 gap-8">
                        <div>
                            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-2">
                                Pilar Akademik & Karakter Kami
                            </h2>
                            <p className="text-gray-600 text-lg">
                                Mengenal lebih dekat para pendidik yang
                                berdedikasi
                            </p>
                        </div>
                        <Link
                            href="/guru"
                            className="inline-flex items-center gap-2 text-white font-bold px-8 py-3 rounded-full hover:shadow-lg transition-all"
                            style={{ backgroundColor: secondaryColor }}
                        >
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                        {pengajar?.slice(0, 4).map((g: any, i: number) => (
                            <div key={i} className="text-center group">
                                ...
                                <p className="text-destructive text-xs font-bold uppercase mt-1">
                                    {g.userDetail?.mengajar || "Guru"}
                                </p>
                            </div>
                        )) || (
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
                        <div className="lg:col-span-4">
                            ...
                            <p className="text-white/80 mb-8">
                                ...
                                kurikulum, pendaftaran, dan fasilitas kami
                            </p>
                            <Link
                                href="/spmb/daftar"
                                className="inline-flex items-center gap-2 bg-yellow-400 text-gray-900 font-bold px-8 py-4 rounded-lg hover:bg-yellow-300 transition-all shadow-lg"
                            >
                                <MessageCircle className="w-5 h-5" /> Hubungi
                                Admin
                            </Link>
                        </div>
                        <div className="lg:col-span-8 space-y-4">
                            {[
                                {
                                    q: "Bagaimana penerapan kurikulum di SMAS St. Bonaventura?",
                                    a: "Kami mengintegrasikan platform e-learning dengan standar internasional, memungkinkan siswa mengakses materi 24/7.",
                                },
                                {
                                    q: "Apa saja syarat pendaftaran tahun ajaran baru?",
                                    a: "Calon siswa diwajibkan mengikuti tes potensi akademik berbasis digital, wawancara, serta melampirkan nilai rapor SMP.",
                                },
                                {
                                    q: "Apakah ada program beasiswa?",
                                    a: "Ya, kami memiliki program beasiswa prestasi akademik dan non-akademik melalui kemitraan dengan Yayasan Anak-Anak Terang.",
                                },
                            ].map((item, i) => (
                                <div
                                    key={i}
                                    className={`bg-white/10 border border-white/20 rounded-2xl p-6 cursor-pointer transition-all hover:border-yellow-300 faq-item`}
                                    onClick={() =>
                                ...
                                >
                                    <div className="flex justify-between items-center">
                                        ...
                                        <ChevronDown
                                            className={`w-5 h-5 text-yellow-300 transition-transform ${faqOpen === i ? "rotate-180" : ""}`}
                                        />
                                    </div>
                                    {faqOpen === i && (
            ...
            <section className="py-24 bg-yellow-50">
                <div className="max-w-4xl mx-auto px-6 md:px-12 text-center">
                    ...
                    <p className="text-gray-600 text-lg max-w-2xl mx-auto mb-12">
                        Pendaftaran Tahun Ajaran {new Date().getFullYear()}/
                        {new Date().getFullYear() + 1} telah dibuka.
                        Bergabunglah dengan komunitas unggul kami.
                    </p>
                    <div className="flex flex-col sm:flex-row gap-6 justify-center">
                        <Link
                            href="/spmb/daftar"
                            className="inline-flex items-center justify-center gap-2 text-white font-bold px-10 py-5 rounded-lg hover:shadow-xl transition-all"
                            style={{ backgroundColor: secondaryColor }}
                        >
                        ...
                        <Link
                            ...
                            className="inline-flex items-center justify-center gap-2 bg-white border-2 border-yellow-400 text-gray-900 font-bold px-10 py-5 rounded-lg hover:bg-yellow-50 transition-all"
                        >
                            Profil Sekolah
                        </Link>
                    </div>
            ...
            >
                ...
                <div className="mt-20 pt-8 border-t border-white/10 max-w-7xl mx-auto px-6 md:px-12 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-white/40 uppercase tracking-widest">
                    <div>
                        © {new Date().getFullYear()} SMAS St. Bonaventura Madiun
                    </div>
