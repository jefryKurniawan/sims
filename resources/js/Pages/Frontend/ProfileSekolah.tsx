...
const socialLinks = [
  {
    label: 'Facebook', href: 'https://www.facebook.com/groups/smabonamadiun/',
    color: '#1877F2',
    icon: 'M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z',
  },
  {
    label: 'YouTube', href: 'https://www.youtube.com/@smakst.bonaventuramadiun6171',
    color: '#FF0000',
    icon: 'M19.615 3.184c-3.604-.246-11.631-.245-15.23 0-3.897.266-4.356 2.62-4.385 8.816.029 6.185.484 8.549 4.385 8.816 3.6.245 11.626.246 15.23 0 3.897-.266 4.356-2.62 4.385-8.816-.029-6.185-.484-8.549-4.385-8.816zm-10.615 12.816v-8l8 3.993-8 4.007z',
  },
  {
    label: 'Instagram', href: 'https://www.instagram.com/bonaventura_shs/',
    color: '#E4405F',
  ...
  {
    label: 'TikTok', href: 'https://www.tiktok.com/@smastbonaventura',
    color: '#000000',
...
export default function ProfileSekolah({
  ...
  const npsnCount = useCountUp(parseInt(getField(profile.npsn, defaultProfile.npsn)) || 0, 2000);
  ...
  return (
    <>
      ...
      <AnimatePresence mode="wait">
        ...
        >
          {/* Hero Section */}
          <div className="relative h-[480px] overflow-hidden" style={{ background: `linear-gradient(to bottom right, ${primaryColor}, ${secondaryColor}, ${secondaryColor}20)` }}>
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="text-center text-white profile-header opacity-0">
                ...
                <h1 className="text-4xl md:text-5xl font-bold mb-4">
                  {getField(profile.nama_sekolah, defaultProfile.nama_sekolah)}
                </h1>
          ...
          <section className="py-16 -mt-10 relative">
            <div className="container mx-auto px-4">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
                ...
                >
                  ...
                  <p className="text-2xl font-bold text-gray-900">
                    {getField(profile.tahun_berdiri, defaultProfile.tahun_berdiri)}
                  </p>
                </motion.div>
                ...
                >
                  ...
                  <p className="text-2xl font-bold text-gray-900">
                    {getField(profile.akreditasi, defaultProfile.akreditasi)}
                  </p>
                </motion.div>
                ...
                >
                  ...
                  <p className="text-lg font-bold text-gray-900">
                    {getField(profile.kepala_sekolah, defaultProfile.kepala_sekolah)}
                  </p>
                </motion.div>
              </div>
              ...
              <div className="bg-white rounded-2xl shadow-lg p-8 mb-8 border border-gray-100">
                <h2 className="text-2xl font-bold mb-6 flex items-center gap-3" style={{ color: secondaryColor }}>
                  ...
                  <div className="space-y-5">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <a href={`mailto:${getField(profile.email, defaultProfile.email)}`}
                           className="text-gray-700 hover:text-red-600 transition-colors font-medium">
                          {getField(profile.email, defaultProfile.email)}
                        </a>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <a href={`tel:${getField(profile.telepon, defaultProfile.telepon).replace(/\D/g, '')}`}
                           className="text-gray-700 hover:text-red-600 transition-colors font-medium">
                          {getField(profile.telepon, defaultProfile.telepon)}
                        </a>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-5">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <a href="https://maps.app.goo.gl/WVo5c3F3KrYndmwt7" target="_blank" rel="noopener noreferrer"
                           className="text-gray-700 hover:text-red-600 transition-colors">
                          {getField(profile.alamat, defaultProfile.alamat)}
                        </a>
                      </div>
                    </div>

                    <div>
                      <p className="text-xs text-gray-500 font-medium mb-2">Sosial Media</p>
              ...
              <div className="bg-white rounded-2xl shadow-lg p-8 mb-8 border border-gray-100">
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <p className="text-gray-700">{getField(profile.visi, defaultProfile.visi)}</p>
                  </div>
                  <div>
                    <h3 className="text-xl font-semibold text-gray-800 mb-2">Misi</h3>
                    <p className="text-gray-700">{getField(profile.misi, defaultProfile.misi)}</p>
                  </div>
                </div>
              </div>
