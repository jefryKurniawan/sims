                    ...
                    <section className="py-16 -mt-8">
                        <div className="container mx-auto px-4 max-w-5xl">
                            ...
                            >
                                {/* Decorative blobs */}
                                <div
                                    className="absolute top-0 right-0 w-52 h-52 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2"
                                    style={{
                                        backgroundColor: `${secondaryColor}08`,
                                    }}
                                />
                                <div
                                    className="absolute bottom-0 left-0 w-40 h-40 rounded-full blur-3xl translate-y-1/2 -translate-x-1/2"
                                    style={{
                                ...
                                <div className="relative">
                                    ...
                                    <div
                                        className="rounded-2xl p-6 md:p-8 border-2 bg-gray-50/50"
                                        style={{
                            ...
                            <div className="grid lg:grid-cols-2 gap-10 mb-10">
                                ...
                                >
                                    <div
                                        className="absolute top-0 right-0 w-40 h-40 rounded-full blur-2xl -translate-y-1/2 translate-x-1/2"
                                        style={{
                                            backgroundColor: `${primaryColor}15`,
                                        }}
                                    />
