                ...
                <div className="relative h-[300px] bg-gradient-to-br from-primary via-primary-dark to-emerald-900 overflow-hidden">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                        <div className="text-center text-white">
                            ...
                            <h1 className="text-4xl md:text-5xl font-bold mb-4">PPDB Online</h1>
                            <p className="text-xl text-white/90">Tanpa Login - Daftar Langsung</p>
                        </div>
                    </div>
                        ...
                        <div className="max-w-4xl mx-auto">
                            ...
                            <div className="bg-white rounded-2xl shadow-lg p-6 mb-8 border-l-4 border-emerald-500">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        <h3 className="text-lg font-bold text-primary mb-2">Panduan Pendaftaran</h3>
                                        <ul className="text-gray-600 text-sm space-y-1">
                                            <li>✅ Isi formulir di bawah ini dengan data yang benar</li>
                                            <li>✅ Upload bukti pembayaran (jika ada)</li>
                                            <li>✅ <strong>Simpan kode edit</strong> yang akan diberikan setelah pendaftaran</li>
                                            <li>✅ Gunakan kode edit untuk mengubah data atau cek status</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="grid md:grid-cols-2 gap-6">
                                    ...
                                    <div className="md:col-span-2">
                                        ...
                                        <input
                                            ...
                                            className={`w-full px-4 py-3 rounded-lg border ${errors.nisn ? 'border-red-500' : 'border-gray-300'} focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 outline-none transition`}
                                    ...
                                    <div className="md:col-span-2">
                                        ...
                                        <input
                                            ...
                                            className={`w-full px-4 py-3 rounded-lg border ${errors.nama_lengkap ? 'border-red-500' : 'border-gray-300'} focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 outline-none transition`}
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className={`w-full px-4 py-3 rounded-lg border ${errors.tempat_lahir ? 'border-red-500' : 'border-gray-300'} focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 outline-none transition`}
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className={`w-full px-4 py-3 rounded-lg border ${errors.tanggal_lahir ? 'border-red-500' : 'border-gray-300'} focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 outline-none transition`}
                                            required
                                        />
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className={`w-full px-4 py-3 rounded-lg border ${errors.email ? 'border-red-500' : 'border-gray-300'} focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 outline-none transition`}
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className={`w-full px-4 py-3 rounded-lg border ${errors.no_hp ? 'border-red-500' : 'border-gray-300'} focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 outline-none transition`}
                                    ...
                                    <div className="md:col-span-2">
                                        ...
                                        <textarea
                                            ...
                                            rows={3}
                                            className={`w-full px-4 py-3 rounded-lg border ${errors.alamat ? 'border-red-500' : 'border-gray-300'} focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 outline-none transition`}
                                ...
                                <div className="grid md:grid-cols-2 gap-6">
                                    ...
                                    <div className="md:col-span-2">
                                        ...
                                        <input
                                            ...
                                            className={`w-full px-4 py-3 rounded-lg border ${errors.nama_ortu ? 'border-red-500' : 'border-gray-300'} focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 outline-none transition`}
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className={`w-full px-4 py-3 rounded-lg border ${errors.no_hp_ortu ? 'border-red-500' : 'border-gray-300'} focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 outline-none transition`}
                                            placeholder="08xxxxxxxxxx"
                                            required
                                        />
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className={`w-full px-4 py-3 rounded-lg border ${errors.asal_sekolah ? 'border-red-500' : 'border-gray-300'} focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 outline-none transition`}
                                    ...
                                    <div className="md:col-span-2">
                                        ...
                                        <textarea
                                            ...
                                            rows={3}
                                            className={`w-full px-4 py-3 rounded-lg border ${errors.prestasi ? 'border-red-500' : 'border-gray-300'} focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 outline-none transition`}
                                    ...
                                    <div>
                                        ...
                                        <div className="relative">
                                            ...
                                            <input
                                                ...
                                                className={`w-full pl-12 pr-4 py-3 rounded-lg border ${errors.biaya_pendaftaran ? 'border-red-500' : 'border-gray-300'} focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 outline-none transition`}
                                                placeholder="0"
                                                required
                                            />
                                        </div>
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-white/90 text-sm">
                                            Jika mengalami kesulitan dalam pendaftaran, silakan hubungi admin sekolah melalui telepon atau email yang tersedia di halaman kontak.
                                        </p>
                                    </div>
                                </div>
                            </div>
