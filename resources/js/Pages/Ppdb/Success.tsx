                        ...
                        <div className="max-w-3xl mx-auto">
                            ...
                            <div className="bg-white rounded-2xl shadow-xl p-8 mb-6">
                                <div className="text-center mb-8">
                                    ...
                                    <p className="text-gray-600">
                                        Pendaftaran Anda telah berhasil dikirim. Simpan kode edit di bawah ini dengan baik.
                                    </p>
                                </div>
                                ...
                                <div className="bg-gradient-to-br from-primary to-primary-dark rounded-xl p-6 mb-6">
                                    ...
                                    <p className="text-white/80 text-sm mb-4">
                                        Gunakan kode ini untuk mengedit data atau mengecek status pendaftaran
                                    </p>
                                    <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 flex items-center justify-between gap-4">
                                        ...
                                        <button
                                            onClick={() => copyToClipboard(calonSiswa.edit_token)}
                                ...
                                <div className="grid md:grid-cols-2 gap-4 mb-6">
                                    <div className="bg-gray-50 rounded-lg p-4">
                                        ...
                                        <p className="text-gray-900 font-mono">{calonSiswa.nisn}</p>
                                    </div>
                                    <div className="bg-gray-50 rounded-lg p-4">
                                        <div className="flex items-center gap-2 mb-2">
                                            <svg className="w-5 h-5 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        ...
                                        <span className="inline-block px-3 py-1 bg-blue-100 text-blue-700 rounded-full text-sm font-medium">
                                            {calonSiswa.status === 'submitted' ? 'Terverifikasi' : calonSiswa.status}
                                        </span>
                                    </div>
                                </div>
                            ...
                            <div className="bg-amber-50 border-l-4 border-amber-500 rounded-r-xl p-6 mb-6">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        <h3 className="font-bold text-amber-800 mb-2">Penting!</h3>
                                        <ul className="text-amber-700 text-sm space-y-1">
                                            <li>• Kode edit hanya berlaku untuk 3 hari ke depan</li>
                                            <li>• Jangan bagikan kode edit kepada siapapun</li>
                                            <li>• Simpan kode edit di tempat yang aman</li>
                                            <li>• Jika lupa kode edit, hubungi admin sekolah</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="bg-white rounded-xl shadow-lg p-6">
                                ...
                                <div className="space-y-3">
                                    <div className="flex items-start gap-3">
                                        ...
                                        <p className="text-gray-600 text-sm">Administrasi akan memverifikasi berkas pendaftaran Anda</p>
                                    </div>
                                    <div className="flex items-start gap-3">
                                        ...
                                        <p className="text-gray-600 text-sm">Pantau status pendaftaran melalui halaman "Cek Status"</p>
                                    </div>
                                    <div className="flex items-start gap-3">
                                        ...
                                        <p className="text-gray-600 text-sm">Jika diterima, Anda akan mendapat notifikasi dan dapat melakukan daftar ulang</p>
                                    </div>
                                </div>
                            </div>
                        </div>
