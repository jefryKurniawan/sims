...
export default function CheckStatus({ calonSiswa }: Props) {
    ...
    const currentStatus =
        statusConfig[calonSiswa.status as keyof typeof statusConfig] ||
                ...
                <section className="py-12 -mt-16">
                    <div className="container mx-auto px-4">
                        <div className="max-w-4xl mx-auto">
                            {/* Status Card */}
                            <div
                                className={`${currentStatus.bg} ${currentStatus.border} border-2 rounded-2xl p-8 mb-6`}
                            >
                                <div className="flex items-center gap-4 mb-6">
                                    <div
                                        className={`w-16 h-16 ${currentStatus.badge} rounded-xl flex items-center justify-center`}
                                    >
                                        {currentStatus.icon}
                                    </div>
                                    <div>
                                        ...
                                        <p className={currentStatus.text}>
                                ...
                                <div className="flex items-center justify-between mt-8">
                                    {[
                                        ...
                                        const isCompleted =
                                            ...
                                            calonSiswa.status === "tidak_lulus";
                                        const isCurrent =
                                            calonSiswa.status === item.key;
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                {index < 2 && (
                                                    <div
                                                        className={`w-16 sm:w-24 h-1 mx-3 rounded ${
                                                            currentIndex >
                                                            itemIndex
                                                                ? currentStatus.color ===
                                                                  "emerald"
