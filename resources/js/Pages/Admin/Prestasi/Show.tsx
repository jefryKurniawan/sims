                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-gray-600 text-sm mt-1">
                                    Informasi lengkap prestasi siswa
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-xl shadow p-6">
                        ...
                        <div className="border-b pb-6 mb-6">
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <div>
                                    ...
                                    <span
                                        className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium mt-1 ${getJenisBadge(prestasi.jenis)}`}
                                    >
                                        {prestasi.jenis === "akademik"
                                            ? "Akademik"
                                            : "Non-Akademik"}
                                    </span>
                                </div>
                        ...
                        <div className="mt-8 pt-6 border-t">
                            <p className="text-sm text-gray-500">
                                Dibuat:{" "}
                                {new Date(prestasi.created_at).toLocaleString(
                                    "id-ID",
                                )}{" "}
                                | Diupdate:{" "}
                                {new Date(prestasi.updated_at).toLocaleString(
                                    "id-ID",
                                )}
                            </p>
                        </div>
