                ...
                <div className="bg-white border-b">
                    <div className="max-w-4xl mx-auto px-6 py-6">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h1 className="text-2xl font-bold text-gray-900">Tambah Prestasi</h1>
                                <p className="text-gray-600 text-sm mt-1">Catat prestasi siswa baru</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="max-w-4xl mx-auto px-6 py-8">
                    <form onSubmit={handleSubmit} className="bg-white rounded-xl shadow p-8">
                        ...
                        <div className="mb-6">
                            ...
                            <div className="flex items-center gap-4">
                                <label className="flex items-center gap-2 px-4 py-3 border-2 border-dashed border-gray-300 rounded-lg cursor-pointer hover:bg-gray-50 transition">
                                    <Upload className="w-5 h-5 text-gray-500" />
                                    <span className="text-sm text-gray-600">{data.bukti ? data.bukti.name : 'Pilih File'}</span>
                                    <input
                                        type="file"
                            ...
                            {errors.bukti && <p className="text-red-500 text-sm mt-1">{errors.bukti}</p>}
                        </div>
