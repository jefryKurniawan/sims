                ...
                <div className="bg-white border-b">
                    <div className="max-w-4xl mx-auto px-6 py-6">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h1 className="text-2xl font-bold text-gray-900">Edit Prestasi</h1>
                                <p className="text-gray-600 text-sm mt-1">Perbarui data prestasi siswa</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <form onSubmit={handleSubmit} className="bg-white rounded-xl shadow p-8">
                        ...
                        {prestasi.bukti && (
                            <div className="mb-6 p-4 bg-gray-50 rounded-lg">
                                <label className="block text-sm font-semibold text-gray-700 mb-2">Bukti Saat Ini</label>
                                <a
                        ...
                        <div className="flex items-center justify-end gap-4 pt-6 border-t">
                            ...
                            >
                                ...
                                {processing ? 'Menyimpan...' : 'Update Prestasi'}
                            </button>
                        </div>
                    </form>
                </div>
