...
export default function Index() {
    ...
    const columns: Column[] = [
        ...
        },
        {
            ...
            render: (v: string) => (
                <span
                    className={`inline-flex px-2.5 py-0.5 rounded-full text-xs font-medium ${getJenisBadge(v)}`}
                >
                    ...
                    actions={(row) => [
                        {
                            ...
                            onClick: () =>
                                router.visit(
                                    route("admin.prestasi.edit", row.id),
                                ),
                            label: "Edit",
                        },
                        {
                            ...
                            onClick: () =>
                                router.visit(
                                    route("admin.prestasi.show", row.id),
                                ),
                            label: "Detail",
                        },
                        {
