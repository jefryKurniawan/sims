...
export default function Import() {
	...
	const handleSubmit = (e: React.FormEvent) => {
		e.preventDefault();
		post(route("users.pengajar.import"), {
			onSuccess: () => {
				closeModal();
	...
	return (
		<>
			<Head title="Import Guru" />
			<div className="p-4 lg:p-6">
				<div className="mb-6">
					<h1 className="text-2xl font-bold text-gray-900">Import Guru</h1>
					<p className="text-sm text-gray-500">
						Unggah file Excel/CSV untuk mengimpor data guru secara massal.
					</p>
					<div className="mt-2 flex items-center gap-3">
						...
						<a
							href={route("users.pengajar.template")}
