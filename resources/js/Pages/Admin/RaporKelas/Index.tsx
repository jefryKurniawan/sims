...
export default function Index() {
  ...
  const columns: Column[] = [
    ...
    { key: 'jurusan', label: 'Jurusan', render: (_v: any, row: any) => row.jurusan?.singkatan || '-' },
    ...
    <>
      ...
      <div className="p-4 lg:p-6">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-6">
          <div>
            <h1 className="text-2xl lg:text-3xl font-bold text-gray-900 font-heading">Kelas Rapor</h1>
            <p className="text-sm text-gray-500 mt-0.5">Kelola kelas untuk pencetakan rapor</p>
          </div>
          <Link
        ...
        <AdminTable
          ...
          actions={(row) => [
            { icon: 'edit', onClick: () => Inertia.visit(route('rapor-kelas.edit', row.id)), label: 'Edit' },
