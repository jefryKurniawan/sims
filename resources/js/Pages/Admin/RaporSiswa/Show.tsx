...
export default function Show({ rapor }: Props) {
    ...
    const [catatanWali, setCatatanWali] = useState(
        rapor.catatan?.catatan_wali_kelas || "",
    );
    const [catatanOrtu, setCatatanOrtu] = useState(
        rapor.catatan?.catatan_ortu || "",
    );
            ...
            <div className="bg-white rounded-lg border p-6 mb-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <span className="text-sm font-medium">
                            {rapor.siswa.tempat_lahir},{" "}
                            {rapor.siswa.tanggal_lahir}
                        </span>
                    </div>
                    <div>
                        <span className="text-sm text-gray-500">
                        ...
                        <span className="text-sm font-medium">
                            {rapor.siswa.jenis_kelamin}
                        </span>
                    </div>
                    <div>
                        <span className="text-sm text-gray-500">Kelas:</span>{" "}
                        <span className="text-sm font-medium">
                            Kelas {rapor.kelas.tingkat} -{" "}
                            {rapor.kelas.nama_kelas} (
                            {rapor.kelas.jurusan?.singkatan || "-"})
                        </span>
                    </div>
                </div>
            </div>
                            ...
                            rapor.mapel.map((m) => (
                                <tr key={m.id} className="hover:bg-gray-50">
                                    ...
                                    <td className="px-4 py-2 text-sm text-gray-600 max-w-xs">
                                        {m.deskripsi_pengetahuan || "-"}
                                    </td>
                                    <td className="px-4 py-2 text-sm text-gray-600 max-w-xs">
                                        {m.deskripsi_keterampilan || "-"}
                                    </td>
                                </tr>
                            ))
                        )}
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                            <div>
                                ...
                                <input
                                    ...
                                    value={sakit}
                                    onChange={(e) =>
                                        setSakit(Number(e.target.value))
                                    }
                                    className="w-full px-3 py-2 border rounded text-sm"
                                />
                            </div>
