            ...
            <div className="p-4 lg:p-6">
                ...
                <div className="bg-white border border-gray-200 shadow-sm p-6 space-y-4 max-w-2xl">
                    ...
                    <div className="border-t pt-4">
                        ...
                        <span className="inline-flex px-2 py-0.5 text-sm font-medium rounded-full bg-blue-100 text-blue-700">
                            {murid.role}
                        </span>
                    </div>
                    <div className="border-t pt-4">
                        ...
                        <span
                            className={`inline-flex px-2 py-0.5 text-sm font-medium rounded-full ${murid.status === "active" ? "bg-emerald-100 text-emerald-700" : "bg-destructive/10 text-destructive"}`}
                        >
                            {murid.status === "active" ? "Aktif" : "Nonaktif"}
                        </span>
                    </div>
                </div>
            </div>
