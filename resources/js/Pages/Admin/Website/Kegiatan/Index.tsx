        ...
        <AdminLayout
            ...
            header={
                <div className="flex items-center justify-between mb-4">
                    <div>
                        <h1 className="text-xl font-bold text-gray-800">Kegiatan</h1>
                    </div>
                    <Link
            ...
            <div className="overflow-x-auto">
                <table className="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                        {kegiatan && kegiatan.data && kegiatan.data.length > 0 ? (
                            kegiatan.data.map((k: any) => (
                                <tr key={k.id} className="hover:bg-gray-50">
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                                        <Link
                                            href={route('website.kegiatan.edit', k.id)}
                ...
                <div className="flex flex-wrap items-center justify-between px-4 py-2">
                    <div className="flex items-center flex-1">
                        <span className="text-sm text-gray-500">
                            Menampilkan {kegiatan.from} - {kegiatan.to} dari {kegiatan.total} data
                        </span>
                    </div>
