        ...
        <AdminLayout
            ...
            header={
                <div className="flex items-center justify-between mb-4">
                    <div>
                        <h1 className="text-xl font-bold text-gray-800">About Sekolah</h1>
                    </div>
                    <Link
                                ...
                                <tr key={a.id} className="hover:bg-gray-50">
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                        <span className={`px-2 py-0.5 text-xs font-medium rounded-full ${
                                            a.is_active === '0' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'
                                        }`}>
                                            {a.is_active === '0' ? 'Aktif' : 'Tidak Aktif'}
                                        </span>
                                    </td>
                ...
                <div className="flex flex-wrap items-center justify-between px-4 py-2">
                    <div className="flex items-center flex-1">
                        <span className="text-sm text-gray-500">
                            Menampilkan {about.from} - {about.to} dari {about.total} data
                        </span>
                    </div>
