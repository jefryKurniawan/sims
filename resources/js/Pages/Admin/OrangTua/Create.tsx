...
export default function Create() {
    const { siswa, hubunganOptions, pendidikanOptions, penghasilanOptions, statusPernikahanOptions } = usePage().props as any;
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        Inertia.post("/dashboard/orang-tua", data, {
        ...
        <>
            ...
            <div className="p-4 lg:p-6">
                <div className="mb-6">
                    ...
                    <h1 className="text-2xl font-bold text-gray-900">Tambah Orang Tua / Wali</h1>
                </div>
