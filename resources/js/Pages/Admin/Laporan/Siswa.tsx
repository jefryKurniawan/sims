...
export default function LaporanSiswa({ siswa, error, filters }: any) {
    ...
    const handleExport = (type: "pdf" | "excel") => {
        ...
        window.open(
            `/dashboard/laporan/siswa/export?${params.toString()}`,
            "_blank",
        );
    };
    ...
    const handlePrint = () => {
        ...
        window.open(
            `/dashboard/laporan/siswa/print?${params.toString()}`,
            "_blank",
        );
    };
                            ...
                            <tbody className="divide-y divide-gray-100">
                                {rows.length === 0 ? (
                                    <tr>
                                        ...
                                        >
                                            Tidak ada data siswa untuk filter
                                            yang dipilih
                                        </td>
                                    </tr>
                                ) : (
                            ...
                            {siswa?.last_page && (
                                <tfoot>
                                    <tr className="bg-gray-50">
                                        ...
                                        >
                                            Halaman {siswa.current_page} dari{" "}
                                            {siswa.last_page} - Total{" "}
                                            {siswa.total} data
                                        </td>
                                    </tr>
                                </tfoot>
