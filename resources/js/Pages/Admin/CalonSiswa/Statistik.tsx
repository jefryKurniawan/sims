...
export default function Statistik({ statistik, gelombang, gelombang_id }) {
    return (
        <>
            ...
            <div className="p-6">
                <h1 className="text-2xl font-bold text-gray-800 mb-4">Statistik PPDB</h1>
                <div className="mb-4">
                    <Link
                        href="/dashboard/ppdb"
                ...
                <div className="mb-6">
                    <label className="block text-sm font-medium text-gray-700 mb-1">Gelombang</label>
                ...
                {statistik ? (
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="bg-white p-4 rounded-lg shadow border">
                            <h2 className="font-semibold text-gray-800 mb-2">Jumlah Pendaftar</h2>
                            <p className="text-3xl font-bold text-blue-600">
                                {statistik.total_pendaftar ?? 0}
                            </p>
                        </div>
                        <div className="bg-white p-4 rounded-lg shadow border">
                            <h2 className="font-semibold text-gray-800 mb-2">Lulus</h2>
                            <p className="text-3xl font-bold text-green-600">
                                {statistik.lulus ?? 0}
                            </p>
                        </div>
                        <div className="bg-white p-4 rounded-lg shadow border">
                            <h2 className="font-semibold text-gray-800 mb-2">Tidak Lulus</h2>
                            <p className="text-3xl font-bold text-red-600">
                                {statistik.tidak_lulus ?? 0}
                            </p>
                        </div>
                        <div className="bg-white p-4 rounded-lg shadow border">
                            <h2 className="font-semibold text-gray-800 mb-2">Dalam Seleksi</h2>
