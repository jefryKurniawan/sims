    ...
    return (
        <>
            ...
            <div className="p-6">
                ...
                {flash.success && (
                    <div className="mb-4 p-4 bg-green-100 rounded-lg text-green-800">
                        {flash.success}
                    </div>
                )}
                {flash.error && (
                    <div className="mb-4 p-4 bg-red-100 rounded-lg text-red-800">
                        {flash.error}
                    </div>
                )}
                ...
                <div className="bg-white rounded-lg shadow border p-6">
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div>{siswa.jurusan?.nama ?? "-"}</div>

                        <div className="font-medium text-gray-600">Kelas</div>
                        <div>{siswa.kelasAktif?.kelas?.nama_kelas ?? "-"}</div>
                    </div>
                </div>
            </div>
        </>
