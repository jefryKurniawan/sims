...
export default function Create({ kategori }: Props) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        Inertia.post(route('berita-admin.store'), formData);
    };
    ...
    return (
        <AdminLayout title="Tambah Berita">
            <div className="p-6">
                <div className="mb-6">
                    <h1 className="text-2xl font-bold text-gray-800">Tambah Berita</h1>
                </div>
                ...
                <div className="bg-white rounded-lg border">
                    <div className="px-6 py-4 border-b">
                        <h4 className="text-lg font-semibold text-gray-800">Tambah Berita</h4>
                    </div>
                    <div className="p-6">
