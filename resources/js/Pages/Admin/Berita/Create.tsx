        ...
        <>
            ...
            <div className="p-4 lg:p-6">
                <div className="flex items-center justify-between mb-6">
                    <div>
                        <h1 className="text-2xl lg:text-3xl font-bold text-gray-900 font-heading">Tambah Berita</h1>
                        <p className="text-sm text-gray-500 mt-0.5">Buat artikel berita sekolah</p>
                    </div>
                    <Link
