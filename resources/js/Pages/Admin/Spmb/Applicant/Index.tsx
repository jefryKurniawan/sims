...
export default function Index() {
    ...
    const getStatusBadge = (status: string) => {
        const classes: Record<string, string> = {
            ...
            submitted: 'px-2 py-0.5 text-xs font-md rounded-full bg-blue-100 text-blue-700',
            verifikasi_berkas: 'px-2 py-0.5 text-xs font-md rounded-full bg-yellow-100 text-yellow-700',
            lulus_seleksi: 'px-2 py-0.5 text-xs font-md rounded-full bg-green-100 text-green-700',
            diterima: 'px-2 py-0.5 text-xs font-md rounded-full bg-green-100 text-green-700',
            ditolak: 'px-2 py-0.5 text-xs font-md rounded-full bg-red-100 text-red-700',
        };
        return classes[status] || 'px-2 py-0.5 text-xs font-md rounded-full bg-gray-100 text-gray-700';
    };
                            ...
                            },
                            {
                                ...
                                render: (value: any) => {
                                    const colors: Record<string, string> = {
                                        ...
                                        afirmasi: 'bg-purple-100 text-purple-800',
                                        prestasi: 'bg-orange-100 text-orange-800',
                                    };
                                    const color = colors[value] || 'bg-gray-100 text-gray-800';
                                    return <span className={`px-2 py-0.5 text-xs font-md rounded-full ${color}`}>{value}</span>;
                                },
                            },
                            {
                                key: 'tanggal_lahir',
