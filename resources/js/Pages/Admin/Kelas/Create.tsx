            ...
            <div className="p-6 max-w-2xl mx-auto">
                ...
                <div className="bg-white rounded-xl border border-border shadow-sm">
                    <form onSubmit={submit} className="p-6 space-y-5">
                        <div>
                            <label htmlFor="nama_kelas" className="block text-sm font-medium text-gray-700 mb-1.5">
                            ...
                            />
                            {errors.nama_kelas && (
                                <p className="text-sm text-destructive mt-1">{errors.nama_kelas}</p>
                            )}
                        </div>

                        <div>
                            <label htmlFor="tingkat" className="block text-sm font-medium text-gray-700 mb-1.5">
                        ...
                        <div>
                            <label htmlFor="jurusan_id" className="block text-sm font-medium text-gray-700 mb-1.5">
                                Jurusan
                            </label>
                            <select
                                id="jurusan_id"
                        ...
                        <div>
                            <label htmlFor="wali_kelas_id" className="block text-sm font-medium text-gray-700 mb-1.5">
                                Wali Kelas
                            </label>
                            <select
                                id="wali_kelas_id"
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                <label htmlFor="ruangan" className="block text-sm font-medium text-gray-700 mb-1.5">
                                    Ruangan
                                </label>
                                <input
                                    type="text"
                            ...
                            <div>
                                <label htmlFor="kapasitas" className="block text-sm font-medium text-gray-700 mb-1.5">
                        ...
                        <div>
                            <label htmlFor="tahun_ajaran" className="block text-sm font-medium text-gray-700 mb-1.5">
                            ...
                            />
                            {errors.tahun_ajaran && (
                                <p className="text-sm text-destructive mt-1">{errors.tahun_ajaran}</p>
                            )}
                        </div>
