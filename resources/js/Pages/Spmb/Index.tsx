    ...
    const alur = [
        {
            ...
            desc: "Buat akun di sistem SPMB dengan NISN, nomor KK, dan email aktif.",
        },
        {
            no: 2,
            icon: ClipboardList,
            judul: "Pilih Jalur & Formulir",
            desc: "Pilih jalur pendaftaran yang sesuai dan lengkapi data diri, orang tua, dan nilai rapor.",
        },
        {
            no: 3,
            icon: FileCheck,
            judul: "Verifikasi Berkas",
            desc: "Panitia memverifikasi dokumen (Kartu Keluarga, Akta Kelahiran, Ijazah/Rapor, KIP/KIS).",
        },
        {
            no: 4,
            icon: BookOpen,
            judul: "Seleksi / Tes Akademik",
            desc: "Peserta mengikuti TKA (jalur prestasi) atau diproses lewat zonasi/afirmasi.",
        },
        {
            no: 5,
            icon: TrendingUp,
            judul: "Peringkat & Pengumuman",
            desc: "Sistem menghitung skor dan menampilkan daftar kelulusan berdasarkan kuota per jalur.",
        },
        {
            no: 6,
            icon: Wallet,
            judul: "Daftar Ulang",
            desc: "Calon yang lulus melakukan daftar ulang dan pembayaran biaya pendidikan.",
        },
    ];

    const timeline = [
        {
            tgl: cfg.tanggal_buka,
            label: "Pendaftaran Dibuka",
            color: "bg-emerald-500",
        },
        {
            tgl: cfg.tanggal_tutup,
            label: "Pendaftaran Ditutup",
            color: "bg-destructive/100",
        },
        {
            tgl: cfg.tanggal_pengumuman,
            label: "Pengumuman Kelulusan",
            color: "bg-blue-500",
        },
        {
            tgl: cfg.tanggal_daftar_ulang,
            label: "Daftar Ulang",
            color: "bg-purple-500",
        },
    ];
                    ...
                    <div className="grid lg:grid-cols-12 gap-12 items-center">
                        <div className="lg:col-span-7">
                            <span className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm border border-white/20 px-4 py-1.5 rounded-full text-sm font-medium mb-6">
                                ...
                                <span>
                                    Penerimaan Peserta Didik Baru &middot; T.A{" "}
                                    {String(cfg.tahun_ajaran)}
                                </span>
                            </span>
                            ...
                            <p className="text-lg md:text-xl text-white/90 mb-8 max-w-2xl">
                                Sistem Penerimaan Murid Baru online sesuai
                                Permendikbudristek. Pilih jurusan, daftar sesuai
                                jalur, dan pantau status kelulusan secara
                                real-time.
                            </p>
                            ...
                            <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-8 shadow-2xl">
                                <div className="flex items-center gap-3 mb-6">
                                    ...
                                    <h3 className="text-xl font-bold">
                                        Kuota T.A {String(cfg.tahun_ajaran)}
                                    </h3>
                                </div>
                ...
                <div className="max-w-7xl mx-auto px-6 md:px-12">
                    <div className="text-center max-w-3xl mx-auto mb-16">
                        ...
                        <p className="text-gray-600 text-lg">
                            Sesuai Permendikbudristek No. 1 Tahun 2025 tentang
                            SPMB, berikut 6 tahap yang perlu dilalui calon
                            peserta didik.
                        </p>
                    </div>
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {alur.map((step) => (
                            ...
                            >
                                ...
                                <step.icon
                                    className="w-10 h-10 text-primary mb-4 mt-2"
                                    strokeWidth={1.8}
                                />
            ...
            <section className="py-24 bg-gray-50">
                <div className="max-w-7xl mx-auto px-6 md:px-12">
                    <div className="text-center max-w-3xl mx-auto mb-16">
                        ...
                        <p className="text-gray-600 text-lg">
                            Pilih jalur sesuai latar belakang dan kondisi kamu
                            untuk kesempatan terbaik masuk.
                        </p>
                    </div>
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {jalur.map((j, idx) => (
                            ...
                            >
                                <div
                                    className={`bg-gradient-to-br ${j.color} text-white p-6 text-center`}
                                >
                                    <j.icon
                ...
                <div className="max-w-7xl mx-auto px-6 md:px-12">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {timeline.map((t, i) => (
                            <div
                                key={i}
                                className="relative bg-white rounded-2xl p-6 shadow-md border-l-4 border-l-yellow-400"
                            >
                                <div
                                    className={`w-3 h-3 rounded-full ${t.color} absolute -left-[7px] top-8`}
                                />
            ...
            <section className="py-24 bg-gradient-to-br from-yellow-50 to-emerald-50">
                <div className="max-w-4xl mx-auto px-6 md:px-12 text-center">
                    ...
                    <p className="text-gray-600 text-lg max-w-2xl mx-auto mb-10">
                        Pendaftaran SPMB 2026 telah dibuka. Daftarkan dirimu
                        sekarang dan jadilah bagian dari generasi unggul,
