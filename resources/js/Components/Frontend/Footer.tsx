    ...
    <>
      ...
      <footer className="text-white pt-20 pb-8" style={{ backgroundColor: secondaryColor }}>
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-white/80 text-sm">
              <li><a href="/berita" className="hover:text-yellow-300 transition-colors">Berita</a></li>
              <li><a href="/event" className="hover:text-yellow-300 transition-colors">Event</a></li>
              <li><a href="/spmb/daftar" className="hover:text-yellow-300 transition-colors">SPMB 2026</a></li>
              <li><a href="/alumni" className="hover:text-yellow-300 transition-colors">Alumni</a></li>
            </ul>
          </div>
          <div>
        ...
        <div className="mt-20 pt-8 border-t border-white/10 max-w-7xl mx-auto px-6 md:px-12 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-white/40 uppercase tracking-widest">
          <div>&copy; {new Date().getFullYear()} SMAS St. Bonaventura Madiun</div>
