...
export default function Header() {
  ...
  const handleNavEnter = (e) => {
    gsap.to(e.currentTarget, { scale: 1.05, color: secondaryColor, duration: 0.3 });
  };
      ...
      >
        <div className="flex justify-between items-center h-20 px-6 md:px-12 max-w-7xl mx-auto">
          ...
          <div className="logo-group flex items-center gap-3">
            <div className="w-10 h-10 rounded-full flex items-center justify-center text-white font-extrabold"
          ...
          <div className="flex items-center gap-4">
            ...
            {/* User / Login icon */}
            <Link href="/auth/login" className="user-icon text-gray-600 hover:text-red-600 transition-colors">
        ...
        >
          ...
          <nav className="flex flex-col p-6 gap-4">
            ...
            <Link
              ...
              onClick={() => setMobileOpen(false)}
              className={`text-lg font-semibold py-2 border-b
                ${currentPath === '/auth/login' ? 'text-red-600' : 'text-gray-800'}`}
            >
              Masuk
            </Link>
          </nav>
