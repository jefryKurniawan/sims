...
export default function Create() {
    ...
    const [form] = useForm({
        name: '',
        email: '',
        username: '', // not needed? actually generated from name
        nip: '',
        foto_profile: null,
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        // Note: username is auto-generated from name in backend, but we can still send it? Actually the backend generates username from name.
        // We'll not include username in form.
        post(route('backend-pengguna-ppdb.store'), form);
        form.reset();
        setPreview('');
    };
    ...
    return (
        <>
            <div className="mb-6">
                <h1 className="text-2xl font-bold">Tambah Staf PPDB Baru</h1>
                <Link
