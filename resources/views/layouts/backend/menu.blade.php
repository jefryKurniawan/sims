        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class=" nav-item">
                ...
                <ul class="menu-content">
                    ...
                    <li class="nav-item {{ (request()->is('dashboard/website/kegiatan*')) ? 'active' : '' }}">
                        <a class="d-flex align-items-center" href=" {{route('kegiatan.index')}} "><i data-feather="circle"></i>
                    ...
                    <li><a class="d-flex align-items-center" href="#"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="Second Level">Tentang</span></a>
                        <ul class="menu-content">
                            <li class="nav-item {{ (request()->is('dashboard/website/profile-sekolah*')) ? 'active' : '' }}">
                                <a class="d-flex align-items-center" href="{{route('profile-sekolah.index')}}"><span class="menu-item text-truncate" data-i18n="Third Level">Profile Sekolah</span></a>
                            </li>
                            <li class="nav-item {{ (request()->is('dashboard/website/visimisi*')) ? 'active' : '' }}">
                                <a class="d-flex align-items-center" href="{{route('visimisi.index')}}"><span class="menu-item text-truncate" data-i18n="Third Level">Visi dan Misi</span></a>
                            </li>
                        </ul>
                    </li>
                </ul>
            ...
            <li class=" nav-item">
                ...
                <ul class="menu-content">
                    <li class="nav-item {{ (request()->is('dashboard/website/berita*')) ? 'active' : '' }}">
                        <a class="d-flex align-items-center" href=" {{route('berita.index')}} "><i data-feather="circle"></i>
                            <span class="menu-item text-truncate" data-i18n="Basic">Data Berita</span>
                        </a>
                    </li>
                    <li class="nav-item {{ (request()->is('dashboard/website/kategori-berita*')) ? 'active' : '' }}">
                        <a class="d-flex align-items-center" href=" {{route('kategori-berita.index')}} "><i data-feather="circle"></i>
                            <span class="menu-item text-truncate" data-i18n="Basic">Kategori Berita</span>
                        </a>
                    </li>
                    <li class="nav-item {{ (request()->is('dashboard/website/event*')) ? 'active' : '' }}">
                        <a class="d-flex align-items-center" href=" {{route('event.index')}} "><i data-feather="circle"></i>
            ...
            <li class=" nav-item">
                ...
                <ul class="menu-content">
                    <li class="nav-item {{ (request()->is('dashboard/website/about*')) ? 'active' : '' }}">
                        <a class="d-flex align-items-center" href=" {{route('about.index')}} "><i data-feather="circle"></i>
                            <span class="menu-item text-truncate" data-i18n="Basic">About</span>
                        </a>
                    </li>
                    <li class="nav-item {{ (request()->is('dashboard/website/slider*')) ? 'active' : '' }}">
                        <a class="d-flex align-items-center" href=" {{route('slider.index')}} "><i data-feather="circle"></i>
                            <span class="menu-item text-truncate" data-i18n="Basic">Gambar Slider</span>
                        </a>
                    </li>
                    <li class="nav-item {{ (request()->is('dashboard/website/video*')) ? 'active' : '' }}">
                        <a class="d-flex align-items-center" href=" {{route('video.index')}} "><i data-feather="circle"></i>
                            <span class="menu-item text-truncate" data-i18n="Basic">Video</span>
                        </a>
                    </li>

                    <li class="nav-item {{ (request()->is('dashboard/website/footer*')) ? 'active' : '' }}">
                        <a class="d-flex align-items-center" href=" {{route('footer.index')}} "><i data-feather="circle"></i>
            ...
            <li class=" nav-item">
                ...
                <ul class="menu-content">
                    <li class="nav-item {{ (request()->is('dashboard/users/pengajar*')) ? 'active' : '' }}">
                        <a class="d-flex align-items-center" href=" {{route('users.pengajar.index')}} "><i data-feather="circle"></i>
                            <span class="menu-item text-truncate" data-i18n="Basic">Pengajar</span>
                        </a>
                    </li>
                    <li class="nav-item {{ (request()->is('dashboard/users/staf*')) ? 'active' : '' }}">
                        <a class="d-flex align-items-center" href=" {{route('users.staf.index')}} "><i data-feather="circle"></i>
                            <span class="menu-item text-truncate" data-i18n="Basic">Staf</span>
                        </a>
                    </li>
                    <li class="nav-item {{ (request()->is('dashboard/users/murid*')) ? 'active' : '' }}">
                        <a class="d-flex align-items-center" href=" {{route('users.murid.index')}} "><i data-feather="circle"></i>
                            <span class="menu-item text-truncate" data-i18n="Basic">Murid</span>
                        </a>
                    </li>
                    <li class="nav-item {{ (request()->is('dashboard/users/ppdb*')) ? 'active' : '' }}">
                        <a class="d-flex align-items-center" href=" {{route('users.ppdb.index')}} "><i data-feather="circle"></i>
                            <span class="menu-item text-truncate" data-i18n="Basic">PPDB</span>
                        </a>
                    </li>
                    <li class="nav-item {{ (request()->is('dashboard/users/perpus*')) ? 'active' : '' }}">
                        <a class="d-flex align-items-center" href=" {{route('users.perpus.index')}} "><i data-feather="circle"></i>
                            <span class="menu-item text-truncate" data-i18n="Basic">Perpustakaan</span>
                        </a>
                    </li>
                    <li class="nav-item {{ (request()->is('dashboard/users/bendahara*')) ? 'active' : '' }}">
                        <a class="d-flex align-items-center" href=" {{route('users.bendahara.index')}} "><i data-feather="circle"></i>
            ...
            <li class=" nav-item">
                <a class="d-flex align-items-center" href="#"><i data-feather="award"></i>
                    <span class="menu-title text-truncate" data-i18n="e-Rapor">e-Rapor</span>
                </a>
                <ul class="menu-content">
                    <li class="nav-item {{ (request()->is('dashboard/erapor/dapodik-sync*')) ? 'active' : '' }}">
                        <a class="d-flex align-items-center" href="{{ route('admin.erapor.dapodik-sync.index') }}"><i data-feather="circle"></i>
                            <span class="menu-item text-truncate" data-i18n="Sinkronisasi">Sinkronisasi Dapodik</span>
                        </a>
                    </li>
                    <li class="nav-item {{ (request()->is('dashboard/erapor/tujuan-pembelajaran*')) ? 'active' : '' }}">
                        <a class="d-flex align-items-center" href="{{ route('admin.erapor.tujuan-pembelajaran.index') }}"><i data-feather="circle"></i>
                            <span class="menu-item text-truncate" data-i18n="TP">Tujuan Pembelajaran</span>
                        </a>
                    </li>
                    <li class="nav-item {{ (request()->is('dashboard/erapor/nilai*')) ? 'active' : '' }}">
                        <a class="d-flex align-items-center" href="{{ route('admin.erapor.nilai.index') }}"><i data-feather="circle"></i>
                            <span class="menu-item text-truncate" data-i18n="Nilai">Asesmen (Nilai)</span>
                        </a>
                    </li>
                    <li class="nav-item {{ (request()->is('dashboard/erapor/p5*')) ? 'active' : '' }}">
                        <a class="d-flex align-items-center" href="{{ route('admin.erapor.p5.index') }}"><i data-feather="circle"></i>
                            <span class="menu-item text-truncate" data-i18n="P5">Projek P5</span>
                        </a>
                    </li>
                </ul>
            </li>
