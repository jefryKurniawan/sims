...
class BendaharaController extends Controller
{
    ...
    {
        return Inertia::render('Admin/Bendahara/Create');
    }
    ...
    public function store(BendaharaRequest $request)
    {
        try {
            ...
            return redirect()->route('users.bendahara.index');
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            $user->password         = bcrypt('12345678'); // Note: password reset? Might want to keep existing password. But original code resets password on update. We'll keep as is.
            $user->save();
    ...
    public function destroy($id)
    {
        ...
        session()->flash('success','Bendahara Berhasil dihapus !');
        return redirect()->route('users.bendahara.index');
    }
}